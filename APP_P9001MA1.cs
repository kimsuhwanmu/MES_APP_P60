...
namespace MES_APP_P90
{
    ...
    public partial class APP_P9001MA1 : UserControl
    {
        ...
        public struct grid1_COLUMN
        {
            ...
            public const string OPR_NM = "OPR_NM";   //공정명
            ...
            public const string WK_ORD_QTY = "WK_ORD_QTY";  //지시수량
            public const string PROD_QTY = "PROD_QTY";    //생산수량
            public const string WORKER_ID = "WORKER_ID";    //사용처(혹은 작업자)
            public const string EMP_DESC = "EMP_DESC";    //사용처(혹은 작업자)
            public const string STATUS = "STATUS";        //
            public const string REAL_START_TM = "REAL_START_TM";  //실착수일
            public const string REAL_END_TM = "REAL_END_TM";  //실종료일
            public const string FACILITY_CD = "FACILITY_CD";    // 작업설비
            public const string WK_FACILITY_NM = "WK_FACILITY_NM";  //작업설비명
            public const string WK_ORD_UNIT = "WK_ORD_UNIT"; //단위

            public const string REQ_A_QTY = "REQ_A_QTY";    //성형주간작업계획량
            public const string REQ_B_QTY = "REQ_B_QTY";    //성형야간작업계획량
            public const string REQ_1H_QTY = "REQ_1H_QTY";  //투입(~1H)	5-1
            public const string REQ_2H_QTY = "REQ_2H_QTY";  //투입(~2H)	5-2
            public const string REQ_4H_QTY = "REQ_4H_QTY";  //투입(~4H) 5-3
            public const string REQ_4H_OVER_QTY = "REQ_4H_OVER_QTY"; //투입(4H~) 5-4

            public const string PLAN_START_DT = "PLAN_START_DT";//착수시점
            public const string CAST_CHANGE = "CAST_CHANGE"; //금형교환
            public const string RESULT_NO = "RESULT_NO"; // 실적번호
            public const string RESULT_FLAG = "RESULT_FLAG"; // 예외실적 여부

            public const string BEFORE_WORK_FLAG = "BEFORE_WORK_FLAG"; //전공정 실적 체크 'F'면 전공정 실적수량이 부족 함
        }
        ...
        string sFACILITY_TYPE = ""; //설비타입
        string sWC_NM = "";
        string sWORKER_CD = "";
        string sWORKER_NM = "";      // 작업자명
        string sITEM_CD = "";
        string sITEM_NM = "";
        ...
        private void CommandRun_Event()
        {
            ...
            vSendData.Tables["COMMAND"].Rows.Add("APP_RUN", "MES_APP_P50.APP_P5004MA1", "", "", "");
        ...
        private void CommandRun_Event(int index)
        {
            ...
            if (index == 0)
            {
                ...
                vSendData.Tables["PassData"].Rows[0]["FACILITY_CD"] = opn_FA_CD.Value;
                vSendData.Tables["PassData"].Rows[0]["WORKER_CD"] = cboWorker.Value;
            }
            else if (index == 1) // P50의 생산실적등록으로 넘어감
            {
                vSendData.Tables["COMMAND"].Columns.Add("COMMAND_ID");
                vSendData.Tables["COMMAND"].Columns.Add("REFERENCE1");
                vSendData.Tables["COMMAND"].Columns.Add("REFERENCE2");
                ...
                vSendData.Tables["PassData"].Columns.Add("PLANT_CD");
                vSendData.Tables["PassData"].Columns.Add("WORKER_CD");
                vSendData.Tables["PassData"].Columns.Add("WORKER_NM");
                vSendData.Tables["PassData"].Columns.Add("WC_MGR");
                vSendData.Tables["PassData"].Columns.Add("WC_MGR_NM");
                vSendData.Tables["PassData"].Columns.Add("WC_CD");
                vSendData.Tables["PassData"].Columns.Add("WC_NM");
                vSendData.Tables["PassData"].Columns.Add("FACILITY_CD");
                vSendData.Tables["PassData"].Columns.Add("FACILITY_NM");
                vSendData.Tables["PassData"].Columns.Add("PRODT_ORDER_NO");
                vSendData.Tables["PassData"].Columns.Add("ITEM_CD");
                vSendData.Tables["PassData"].Columns.Add("ITEM_NM");
                ...
                vSendData.Tables["PassData"].Rows[0]["PLANT_CD"] = sPLANT_CD;
                vSendData.Tables["PassData"].Rows[0]["WORKER_CD"] = cboWorker.Value;
                vSendData.Tables["PassData"].Rows[0]["WORKER_NM"] = cboWorker.ValueName;
                vSendData.Tables["PassData"].Rows[0]["WC_MGR"] = sWC_MGR;
                vSendData.Tables["PassData"].Rows[0]["WC_MGR_NM"] = sWC_MGR;
                vSendData.Tables["PassData"].Rows[0]["WC_CD"] = sWC_CD;
                vSendData.Tables["PassData"].Rows[0]["WC_NM"] = sWC_CD;
                vSendData.Tables["PassData"].Rows[0]["FACILITY_CD"] = opn_FA_CD.Value;
                vSendData.Tables["PassData"].Rows[0]["FACILITY_NM"] = opn_FA_CD.ValueName;
                vSendData.Tables["PassData"].Rows[0]["PRODT_ORDER_NO"] = sPRODT_ORDER_NO + "-" + sOPR_NO;
                vSendData.Tables["PassData"].Rows[0]["ITEM_CD"] = sITEM_CD;
                vSendData.Tables["PassData"].Rows[0]["ITEM_NM"] = sITEM_NM;
            }
            else if (index == 2) // P50의 생산실적등록으로 넘어감
            {
                vSendData.Tables["COMMAND"].Columns.Add("COMMAND_ID");
                vSendData.Tables["COMMAND"].Columns.Add("REFERENCE1");
                vSendData.Tables["COMMAND"].Columns.Add("REFERENCE2");
                ...
                vSendData.Tables["PassData"].Rows[0]["PLANT_CD"] = sPLANT_CD;
                vSendData.Tables["PassData"].Rows[0]["WORKER_CD"] = Grid1.CurrentRow.Cells[grid1_COLUMN.WORKER_ID].Value.ToString().Trim();
                vSendData.Tables["PassData"].Rows[0]["WORKER_NM"] = Grid1.CurrentRow.Cells[grid1_COLUMN.EMP_DESC].Value.ToString().Trim();
                vSendData.Tables["PassData"].Rows[0]["WC_MGR"] = sWC_MGR;
                vSendData.Tables["PassData"].Rows[0]["WC_MGR_NM"] = sWC_MGR;
                vSendData.Tables["PassData"].Rows[0]["WC_CD"] = sWC_CD;
                vSendData.Tables["PassData"].Rows[0]["WC_NM"] = sWC_CD;
                vSendData.Tables["PassData"].Rows[0]["FACILITY_CD"] = Grid1.CurrentRow.Cells[grid1_COLUMN.FACILITY_CD].Value.ToString().Trim();
                vSendData.Tables["PassData"].Rows[0]["FACILITY_NM"] = Grid1.CurrentRow.Cells[grid1_COLUMN.WK_FACILITY_NM].Value.ToString().Trim();
                vSendData.Tables["PassData"].Rows[0]["PRODT_ORDER_NO"] = sPRODT_ORDER_NO + "-" + sOPR_NO;
                vSendData.Tables["PassData"].Rows[0]["ITEM_CD"] = sITEM_CD;
                vSendData.Tables["PassData"].Rows[0]["ITEM_NM"] = sITEM_NM;
            }
        ...
        //OVERLOADING
        private void CommandRun_Event(string prodt_order_no,string opr_no,string item_cd,string item_nm)
        {
            ...
            vSendData.Tables["PassData"].Rows[0]["FACILITY_CD"] = opn_FA_CD.Value;
            vSendData.Tables["PassData"].Rows[0]["FACILITY_NM"] = opn_FA_CD.ValueName;
            vSendData.Tables["PassData"].Rows[0]["PRODT_ORDER_NO"] = prodt_order_no + "-" + opr_no;
            vSendData.Tables["PassData"].Rows[0]["ITEM_CD"] = item_cd;
            vSendData.Tables["PassData"].Rows[0]["ITEM_NM"] = item_nm;
        ...
        //OVERLOADING
        private void CommandRun_Event(string prodt_order_no, string opr_no, string wk_cd,string wk_nm,
            string fa_Cd,string fa_nm,string item_cd,string item_nm)
        {
            ...
            vSendData.Tables["PassData"].Rows[0]["PLANT_CD"] = sPLANT_CD;
            vSendData.Tables["PassData"].Rows[0]["WORKER_CD"] = wk_cd;
            vSendData.Tables["PassData"].Rows[0]["WORKER_NM"] = wk_nm;
            vSendData.Tables["PassData"].Rows[0]["WC_MGR"] = sWC_MGR;
            vSendData.Tables["PassData"].Rows[0]["WC_MGR_NM"] = sWC_MGR;
            vSendData.Tables["PassData"].Rows[0]["WC_CD"] = sWC_CD;
            vSendData.Tables["PassData"].Rows[0]["WC_NM"] = sWC_CD;
            vSendData.Tables["PassData"].Rows[0]["FACILITY_CD"] = fa_Cd;
            vSendData.Tables["PassData"].Rows[0]["FACILITY_NM"] = fa_nm;
            vSendData.Tables["PassData"].Rows[0]["PRODT_ORDER_NO"] = prodt_order_no + "-" + opr_no;
            vSendData.Tables["PassData"].Rows[0]["ITEM_CD"] = item_cd;
            vSendData.Tables["PassData"].Rows[0]["ITEM_NM"] = item_nm;
        ...
        private void CommandRun_WC()
        {
            ...
            vSendData.Tables["COMMAND"].Rows.Add("WC_CHANGE", "MES_APP_P50.APP_P5004MA1", "", "", "");
            ...
            vSendData.Tables["PassData"].Rows[0]["PLANT_CD"] = sPLANT_CD;
            vSendData.Tables["PassData"].Rows[0]["WORKER_CD"] = sWORKER_CD;
            vSendData.Tables["PassData"].Rows[0]["WORKER_NM"] = sWORKER_NM;
            vSendData.Tables["PassData"].Rows[0]["WC_MGR"] = sWC_MGR;
            vSendData.Tables["PassData"].Rows[0]["WC_MGR_NM"] = sWC_MGR;
            vSendData.Tables["PassData"].Rows[0]["WC_CD"] = sWC_CD;
            vSendData.Tables["PassData"].Rows[0]["WC_NM"] = sWC_CD;
            vSendData.Tables["PassData"].Rows[0]["FACILITY_CD"] = sFACILITY_CD;
            vSendData.Tables["PassData"].Rows[0]["FACILITY_NM"] = sFACILITY_CD;
            vSendData.Tables["PassData"].Rows[0]["PRODT_ORDER_NO"] = sPRODT_ORDER_NO + "-" + sOPR_NO;
            vSendData.Tables["PassData"].Rows[0]["ITEM_CD"] = sITEM_CD;
            vSendData.Tables["PassData"].Rows[0]["ITEM_NM"] = sITEM_NM;
            CommandRun_Event(vSendData);  //이벤트 실행
        ...
        private int Load_Facility()
        {
            ...
            try
            {
              ...
              /*  DataTable dtTmp = (DataTable)cboFacility.DataSource;
                ...
                if (dtData1 != null && dtData1.Rows.Count > 0)
                {
                    sFACILITY_TYPE = dtData1.Rows[0][2].ToString();//설비 자원 기본값 설정
        ...
        private void InitSpreadSheet(int p_GridIndex)   //선택된 스프레드시트를 초기화 한다.
        {
            ...
            if (p_GridIndex == 1)
            {
                ...
                Grid1.Columns.Add(SetColumnImage(grid1_COLUMN.CHECKFLAG, "√", 30));    //이미지형태의 그리드

                Grid1.Columns.Add(SetColumnEdit(grid1_COLUMN.SEQ, "NO", 40));                
                if (sWC_MGR == "40") // 아산
                {
                    Grid1.Columns.Add(SetColumnEdit(grid1_COLUMN.WK_DT, "계획시각", 60));
                }
                else
                {
                ...
                Grid1.Columns.Add(SetColumnEdit(grid1_COLUMN.OPR_NO, "공순", 40));
                Grid1.Columns.Add(SetColumnEdit(grid1_COLUMN.OPR_NM, "공정명", 60));

                Grid1.Columns.Add(SetColumnEdit(grid1_COLUMN.WK_ORD_NO, "작업지시번호", 170));
                Grid1.Columns.Add(SetColumnEdit(grid1_COLUMN.ITEM_CD, "품번", 120));
                Grid1.Columns.Add(SetColumnEdit(grid1_COLUMN.ITEM_NM, "품명", 130));
                Grid1.Columns.Add(SetColumnEdit(grid1_COLUMN.SPEC, "규격", 130));
                ...
                Grid1.Columns.Add(SetColumnEdit(grid1_COLUMN.REQ_A_QTY, "주간", 75));    // 삭제
                Grid1.Columns.Add(SetColumnEdit(grid1_COLUMN.REQ_B_QTY, "야간", 75));    // 삭제

                Grid1.Columns.Add(SetColumnEdit(grid1_COLUMN.REQ_1H_QTY, "~1H투입", 65));  // 삭제
                Grid1.Columns.Add(SetColumnEdit(grid1_COLUMN.REQ_2H_QTY, "~2H투입", 65)); // 삭제
                Grid1.Columns.Add(SetColumnEdit(grid1_COLUMN.REQ_4H_QTY, "~4H투입", 65)); // 삭제
                Grid1.Columns.Add(SetColumnEdit(grid1_COLUMN.REQ_4H_OVER_QTY, "4H~투입", 65)); // 삭제
                ...
                //if (sWC_MGR == "10")
                //{
                //    Grid1.Columns.Add(SetColumnEdit(grid1_COLUMN.WORKER_ID, "작업자", 65));
                //    Grid1.Columns.Add(SetColumnEdit(grid1_COLUMN.EMP_DESC, "사용처", 65));
                //}
                //else
                //{
                    Grid1.Columns.Add(SetColumnEdit(grid1_COLUMN.WORKER_ID, "작업자", 60));
                    Grid1.Columns.Add(SetColumnEdit(grid1_COLUMN.EMP_DESC, "작업자", 60));

                //}

                Grid1.Columns.Add(SetColumnEdit(grid1_COLUMN.RESULT_FLAG, "작업구분", 90));
                Grid1.Columns.Add(SetColumnEdit(grid1_COLUMN.STATUS, "상태", 60));
                Grid1.Columns.Add(SetColumnEdit(grid1_COLUMN.FACILITY_CD, "작업설비", 0));
                Grid1.Columns.Add(SetColumnEdit(grid1_COLUMN.WK_FACILITY_NM, "작업설비", 80));
                ...
                Grid1.Columns.Add(SetColumnEdit(grid1_COLUMN.PRODT_ORDER_NO, "제조오더번호", 85));
               ...
               // Grid1.Columns[grid1_COLUMN.OPR_NO].Visible = false;
                ...
                //if (sWC_MGR == "30")
                //{
                //    Grid1.Columns[grid1_COLUMN.CAST_CHANGE].Visible = true; // 금형 변경
                //}
                //else
                //{
        ...
        public void InitData()
        {
            ...
            if (sWC_MGR == "30") //성형이면 설비선택 할수 없게
            {
                ...
                opn_FA_CD.Enabled = false;
                tCheckBox2.Visible = false;
            }
            else
            {
                opn_FA_CD.Enabled = true;
        ...
        #region 작업지시현황 정보 조회
        private void DBSave_Unwork_save(DataTable resultTable)
        {
            ...
            {
                strData = ""
                        + " EXEC DBO.USP_MES_P_UNWORK_SAVE"
                        + " @SAVE_FLAG = 'I'"
                        + " , @PLANT_CD = '" + sPLANT_CD + "'"
                        + " , @UNWORK_NO = ''"
                        + " , @UNWORK_START_DT = '" + resultTable.Rows[0]["UNWORK_START_DT"].ToString() + "'"
                        + " , @UNWORK_END_DT = '" + resultTable.Rows[0]["UNWORK_END_DT"].ToString() + "'"
                        + " , @WC_MGR = '" + sWC_MGR + "'"
                        + " , @WC_CD = '" + sWC_CD + "'"
                        + " , @FACILITY_CD = '" + sFACILITY_CD + "'"
                        + " , @OP_CD = '" + resultTable.Rows[0]["OP_CD"].ToString() + "'"
                        + " , @UNWORK_MIN = '0'"
                        + " , @WK_ORD_NO = ''"
                        + " , @RESULT_NO = ''"
                ...
                if (!strState.Equals("OK"))
                {
                    TGSControl.UsrFunction.MessageBoxErr(strState.Substring(2), "비가동 등록");
                    return;
                }
                DBQuery();
            }
            ...
            {
                TGSControl.UsrFunction.MessageBoxErr(se.Message, "비가동 등록");
            }
            finally
            {
                LoadingForm(false);
        ...
        private void DBQuery_Work_Order_RetriveData()//작업지시현황을 조회 
        {
            ...
            try
            {
                ...
                strData += "@FACILITY_CD ='" + opn_FA_CD.Value.ToString().Trim() + "',";  //설비번호
                strData += "@MES_FLG ='"+ mes_flg + "'"; 
                ...
                for (int i = 0; i < dtData1.Rows.Count; i++)
                {
                    ...
                    Grid1.Rows[i].Cells[grid1_COLUMN.SPEC].Value = dtData1.Rows[i][grid1_COLUMN.SPEC].ToString(); //규격
                    ...
                    Grid1.Rows[i].Cells[grid1_COLUMN.WK_ORD_QTY].Value = Convert.ToDecimal(dtData1.Rows[i][grid1_COLUMN.WK_ORD_QTY].ToString()).ToString(s_unit); //지시수량
                    Grid1.Rows[i].Cells[grid1_COLUMN.PROD_QTY].Value = Convert.ToDecimal(dtData1.Rows[i][grid1_COLUMN.PROD_QTY].ToString()).ToString(s_unit); //생산수량

                    Grid1.Rows[i].Cells[grid1_COLUMN.REQ_A_QTY].Value = Convert.ToDecimal(dtData1.Rows[i][grid1_COLUMN.REQ_A_QTY].ToString()).ToString(s_unit); //생산수량
                    Grid1.Rows[i].Cells[grid1_COLUMN.REQ_B_QTY].Value = Convert.ToDecimal(dtData1.Rows[i][grid1_COLUMN.REQ_B_QTY].ToString()).ToString(s_unit); //생산수량

                    Grid1.Rows[i].Cells[grid1_COLUMN.REQ_1H_QTY].Value = Convert.ToDecimal(dtData1.Rows[i][grid1_COLUMN.REQ_1H_QTY].ToString()).ToString(s_unit); //생산수량
                    Grid1.Rows[i].Cells[grid1_COLUMN.REQ_2H_QTY].Value = Convert.ToDecimal(dtData1.Rows[i][grid1_COLUMN.REQ_2H_QTY].ToString()).ToString(s_unit); //생산수량
                    Grid1.Rows[i].Cells[grid1_COLUMN.REQ_4H_QTY].Value = Convert.ToDecimal(dtData1.Rows[i][grid1_COLUMN.REQ_4H_QTY].ToString()).ToString(s_unit); //생산수량
                    Grid1.Rows[i].Cells[grid1_COLUMN.REQ_4H_OVER_QTY].Value = Convert.ToDecimal(dtData1.Rows[i][grid1_COLUMN.REQ_4H_OVER_QTY].ToString()).ToString(s_unit); //생산수량
                    ...
                    Grid1.Rows[i].Cells[grid1_COLUMN.RESULT_FLAG].Value = dtData1.Rows[i][grid1_COLUMN.RESULT_FLAG].ToString(); //구분
                    if (dtData1.Rows[i][grid1_COLUMN.REAL_START_TM].ToString().Length > 0 &&
                        dtData1.Rows[i][grid1_COLUMN.REAL_END_TM].ToString().Length == 0)
                    {
                        if (dtData1.Rows[i][grid1_COLUMN.RESULT_FLAG].ToString() == "ST")
                        {
                            Grid1.Rows[i].Cells[grid1_COLUMN.STATUS].Value = "작업중"; //작업상태
                            Grid1.Rows[i].Cells[grid1_COLUMN.STATUS].Style.ForeColor = Color.Blue;
                        }
                        else if (dtData1.Rows[i][grid1_COLUMN.RESULT_FLAG].ToString() == "END")
                        {
                            Grid1.Rows[i].Cells[grid1_COLUMN.STATUS].Value = "생산완료"; //작업상태
                            Grid1.Rows[i].Cells[grid1_COLUMN.STATUS].Style.ForeColor = Color.Blue;
                        }
                        else
                        {
                    ...
                    else
                    {
                        ...
                        if (dtData1.Rows[i][grid1_COLUMN.RESULT_FLAG].ToString() == "END")
                        {
                            Grid1.Rows[i].Cells[grid1_COLUMN.STATUS].Value = "생산완료"; //작업상태
                            Grid1.Rows[i].Cells[grid1_COLUMN.STATUS].Style.ForeColor = Color.Blue;
                        }
                    ...
                    Grid1.Rows[i].Cells[grid1_COLUMN.FACILITY_CD].Value = dtData1.Rows[i][grid1_COLUMN.FACILITY_CD].ToString(); //작업설비
                    ...
                    Grid1.Rows[i].Cells[grid1_COLUMN.OPR_NM].Value = dtData1.Rows[i][grid1_COLUMN.OPR_NM].ToString(); //공정명
            ...
            try
            {
                ...
                if (!bQueryOnly)
                {
                    if (dtData1.Rows.Count > 0)
                    {
                        ...
                        sWC_CD = dtData1.Rows[0]["WC_CD"].ToString();
                        sWC_NM = dtData1.Rows[0]["WC_NM"].ToString();
                    }
                    else
                    {
        ...
        private void Work_Start()
        {
            ...
            try
            {
                ...
                //2023-01-25 손유진 수정 시작


                if (Grid1.Rows.Count == 0)
                {
                    TGSControl.UsrFunction.MessageBoxErr("제조오더가 없습니다.", "작업시작");
                    return;
                }

                if (Grid1.CurrentRow == null)
                {
                    TGSControl.UsrFunction.MessageBoxErr("선택된 품목이 없습니다. \n 품목을 선택해주세요.", "작업시작");
                    return;
                }

                /*  sITEM_CD = Grid1.CurrentRow.Cells[grid1_COLUMN.ITEM_CD].Value.ToString().Trim();
                  sITEM_NM = Grid1.CurrentRow.Cells[grid1_COLUMN.ITEM_NM].Value.ToString().Trim();
                  sPRODT_ORDER_NO = Grid1.CurrentRow.Cells[grid1_COLUMN.PRODT_ORDER_NO].Value.ToString().Trim();
                  sOPR_NO = Grid1.CurrentRow.Cells[grid1_COLUMN.OPR_NO].Value.ToString().Trim();*/


                string item_cd, item_nm, prodt_order_no,
                    opr_no, worker_cd, worker_nm, fa_cd, fa_nm;

                item_cd = Grid1.CurrentRow.Cells[grid1_COLUMN.ITEM_CD].Value.ToString().Trim();
                item_nm = Grid1.CurrentRow.Cells[grid1_COLUMN.ITEM_NM].Value.ToString().Trim();
                prodt_order_no = Grid1.CurrentRow.Cells[grid1_COLUMN.PRODT_ORDER_NO].Value.ToString().Trim();
                opr_no = Grid1.CurrentRow.Cells[grid1_COLUMN.OPR_NO].Value.ToString().Trim();
                worker_cd = Grid1.CurrentRow.Cells[grid1_COLUMN.WORKER_ID].Value.ToString().Trim();
                worker_nm = Grid1.CurrentRow.Cells[grid1_COLUMN.EMP_DESC].Value.ToString().Trim();
                fa_cd = Grid1.CurrentRow.Cells[grid1_COLUMN.FACILITY_CD].Value.ToString().Trim();
                fa_nm = Grid1.CurrentRow.Cells[grid1_COLUMN.WK_FACILITY_NM].Value.ToString().Trim();


                if (Grid1.CurrentRow.Cells[grid1_COLUMN.RESULT_FLAG].Value.ToString().Trim() == "ST") // 작업시작중인경우 작업시작하지않음
                {
                    // 작업중인경우 해당 작업중 작업자를 넘겨줌
                    /*sWORKER_CD = Grid1.CurrentRow.Cells[grid1_COLUMN.WORKER_ID].Value.ToString().Trim();
                    sWORKER_NM = Grid1.CurrentRow.Cells[grid1_COLUMN.EMP_DESC].Value.ToString().Trim();
                    sFACILITY_CD = Grid1.CurrentRow.Cells[grid1_COLUMN.FACILITY_CD].Value.ToString().Trim();
                    sFACILITY_NM = Grid1.CurrentRow.Cells[grid1_COLUMN.WK_FACILITY_NM].Value.ToString().Trim();*/

                    CommandRun_Event(prodt_order_no, opr_no, worker_cd, worker_nm
                        , fa_cd, fa_nm, item_cd, item_nm);    // 생산실적등록탭으로 이동
                    return;
                ...
                else // 작업시작을 하지않은경우
                {
                    ...
                    if (!StartWork(sPLANT_CD,prodt_order_no,opr_no,opn_FA_CD.Value,sWORKER_CD,sWC_MGR)) // 작업시작시켜줌
                    {
                        throw new Exception("작업시작에 실패했습니다.");
                    }

                    FuncWRWorkStart(prodt_order_no, opr_no, item_cd, item_nm); // 생산실적등록탭으로 이동
                }

                #region 2023-01-25 손유진 수정시작 생산실적등록의 작업시작으로 변경됨으로 인한 기존 구문 주석 처리
                /*
        ...
        /// <summary>
        /// 실적 시작 정보 등록 (MES_APP_P50 > APP_P5002MA1의 작업시작에서 가져옴)
        /// </summary>
        /// <returns></returns>
        private bool StartWork(string plant_cd,string prod_order,string Opr_No,string fa_cd,string worker_cd,string wc_mgr)
        {

            string vREAL_START_DT = DateTime.Now.ToString("yyyy-MM-dd HH:mm:00");
            //시작 정보 등록하기
            string strData = "";
            strData += "EXEC XUSP_APP_P9001MA1_SET ";
            strData += " @CUD_FLAG='C'";
            strData += ",@PLANT_CD='" + plant_cd + "'";
            strData += ",@PRODT_ORDER_NO='" + prod_order + "'";
            strData += ",@OPR_NO='" + Opr_No + "'";
            strData += ",@FACILITY_CD='" + fa_cd + "'";
            strData += ",@WORKER_ID='" + worker_cd + "'";
            strData += ",@WC_MGR='" + wc_mgr + "'";
            strData += ",@REAL_START_DT='" + vREAL_START_DT + "'";
            ...
            if (!strState.Equals("OK"))
            {
                TGSControl.UsrFunction.MessageBoxErr(strState, "작업시작 오류");
                return false;
            }
            else
            {
                if (dtData1.Rows.Count > 0)
                {
                    //sResultNo = dtData1.Rows[0]["RESULT_NO"].ToString();
                    if(dtData1.Rows[0]["RESULT_NO"].ToString() == "-1")
                    {
                        TGSControl.UsrFunction.MessageBoxErr("생산가능한 수량이 없습니다", "작업시작 오류");
                        return false;
                    }
                }
            }
        ...
        private string Create_PrintID()
        {
            ...
            string strData = "";
            strData += "DECLARE @DLV_NO		NVARCHAR(30) ";
            strData += "EXEC	xusp_Z_AutoNumbering @CODE_NO='MPR', @DLV_NO=@DLV_NO OUTPUT ";
            strData += "SELECT @DLV_NO ";
            strData += ";";
            ...
            try
            {
                ...
                if (!strState.Equals("OK"))
                {
                    TGSControl.UsrFunction.MessageBoxErr(strState, "작업지시서");
                    return "";
                }
                if (dataT.Rows.Count > 0)
                {
                    @PRINT_NO = dataT.Rows[0][0].ToString().Trim();
                }
            }
            catch (SqlException ex)
            {
                string msg1 = ex.Message;
                TGSControl.UsrFunction.MessageBoxErr(msg1, "작업지시서 출력");
        ...
        //작업지시 또는 제조오더의 공정별 작업지시 정보를 조회 함
        private void Show_WK_ORDER_ROUT(string pWK_ORD_NO)
        {
            if (pWK_ORD_NO != "")
            {
        ...
        public bool DBQuery_GET_UNWORK(string pPLANT_CD, string pFACILITY_CD) //비가동 진행여부 확인
        {
            ...
            try
            {
                ...
                if (dtData1.Rows.Count>0 && dtData1 != null )
                {
        ...
        private void btn_Unwork_Click(object sender, EventArgs e)   //비가동버튼
        {
            ...
            if (dResult == DialogResult.OK)
            {
                ...
                if (myForm.ResultData.Tables["Result"].Rows != null)
                {
                    DBSave_Unwork_save(myForm.ResultData.Tables["Result"]);//비가동등록 저장    //작업지시현황을 조회 
                }
            ...
            //TGSControl.UsrFunction.NewForm_Exec(Global.szHomeDir, "MES_TPC_CM01", strParam, true);
            //UsrFunction.UsrFunction.NewForm_Exec(Global.szHomeDir, "MES_TPC_CM01", strParam, true);
            //임시주석끝
        ...
        private void FuncWRWorkStart(string prodt_order_no, string opr_no, string item_cd, string item_nm)
        {

            //global.WorkingFileWriteAll(); 오류로 인해 주석처리

            //내부에서 명령을 등록해준후 명령이벤트를 실행한다.
            CommandRun_Event(prodt_order_no,opr_no,item_cd,item_nm);
        ...
        private void btnFind_ButtonClick(object sender, EventArgs e)
        {
            ...
            if (dResult == DialogResult.OK)
            {
                ...
                if (myPopupForm.ResultData.Tables["Result"].Rows != null)
                {
                    opn_ITEM_CD.Value = myPopupForm.ResultData.Tables["Result"].Rows[0]["ITEM_CD"].ToString();
        ...
        private void btn_StandardSheet_ButtonClick(object sender, EventArgs e)
        {
            ...
            if (strPrintID == "")
            {
                strPrintID = Create_PrintID();
            }

            if (Grid1.Rows.Count < 1) return;
            for (int i = 0; i < Grid1.Rows.Count; i++)
            {
                Image imgUnChecked = Properties.Resources.CheckBoxUnChecked;
                if (((Image)Grid1.Rows[i].Cells[grid1_COLUMN.CHECKFLAG].Value).Tag == "N")
                {
                    continue;
                }

                string vPRODT_ORDER_NO = Grid1.Rows[i].Cells["PRODT_ORDER_NO"].Value.ToString().Trim();
                if (string.IsNullOrEmpty(vPRODT_ORDER_NO) != true)
                {
                    seq += 1;

                    

                    if (strPrintID == "") return;

                    DataTable dataT = null;
                    dataT = new DataTable();

                    string strData = "";
                    strData += "EXEC DBO.XUSP_TPC_P9001MA1_SET_PRINT ";
                    strData += "@PRINT_ID ='" + strPrintID + "', ";
                    strData += "@SEQ =" + seq + ",";
                    strData += "@PRODT_ORDER_NO ='" + vPRODT_ORDER_NO + "',";
                    strData += "@USER_ID ='" + Global.USER_ID.ToString() + "'";
                    strData += ";";
                    ...
                    {
                        string msg1 = ex.Message;
                        UsrFunction.MessageBoxErr(msg1, "작업지시서 출력");
            ...
            if (seq > 0)
            {
                MES_APP_P90.POP_P9001PA6 myForm = new MES_APP_P90.POP_P9001PA6();

                DataTable dt = new DataTable("PassData");
                dt.Columns.Add("PRINT_ID");

                dt.Rows.Add();
                dt.Rows[0]["PRINT_ID"] = strPrintID;

                myForm.ResultData.Tables.Add(dt);
                myForm.MainForm = this.MainForm;

                myForm.Start();      // 시작함수 실행
                myForm.ShowDialog();
                ...
                //{
                //    int nCnt2 = 0;
                //    DataTable dataT2 = null;
                //    dataT2 = new DataTable();
                //    string strData2 = "";
                //    strData2 += "DELETE ZZ_S_DN_REQ_PRINT WHERE PRINT_ID = '" + strPrintID + "' ";


                //    string strState = TGSClass.DataBase.GetDataSql(sMainForm, strData2, ref dataT2, ref nCnt2);
        ...
        private void btn_WorkOrder_Info_ButtonClick(object sender, EventArgs e)
        {
            if (Grid1.CurrentRow != null)
            {
                ...
                dt.Rows[0]["WC_MGR"] = sWC_MGR;
                dt.Rows[0]["OPR_NO"] = Grid1.CurrentRow.Cells[grid1_COLUMN.OPR_NO].Value.ToString(); ;
        ...
        private void opn_FA_CD_ValueChanged(object sender, EventArgs e)
        {
            /*  sFACILITY_CD = opn_FA_CD.Value;
                  ProcessInform_Review(sFACILITY_CD, ref sWC_CD, ref sWC_NM, false);   //선택된 설비의 작업장 정보*/
            ...
            if(sMainForm.ActiveControl != null)
            {
                if (sMainForm.ActiveControl.Name == "APP_P5004MA0")
                {
                    //CommandRun_WC();
                }
            }
        ...
        {
            sFACILITY_CD = opn_FA_CD.Value;
            MES_SYS_MRO03.POP_MRO_RESOURCE_WC myPopupForm = new MES_SYS_MRO03.POP_MRO_RESOURCE_WC();
            ...
            if (dResult == DialogResult.OK)
            {
                ...
                opn_FA_CD.ValueName = sFACILITY_NM;
                //sFACILITY_TYPE = 
                lbl_WorkCenterNm.Text = sWC_NM;
                /*opn_FA_CD.Value = sFACILITY_CD;
                opn_FA_CD.ValueName = sFACILITY_NM;*/


                Global.workinfo.szFacilityCD = opn_FA_CD.Value;
                Global.workinfo.szFacilityNM = opn_FA_CD.ValueName;
                global.ConfigFileWriteAll();
                //DBQuery();
                //apP_P2002MA11.SetValue(APP_P2002MA1.SetValueName.FACILITY_CD, opn_FA_CD.Value);
                //apP_P2002MA11.SetValue(APP_P2002MA1.SetValueName.FACILITY_NM, opn_FA_CD.ValueName);
